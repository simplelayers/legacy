						...
						<td class="textblockmid">
							<table>
								<tr>
									...
									<td><input type="text" name="username" id="username" style="width: 1.8in;"
											value="<!--{if isset($username)}--><!--{$username}--><!--{/if}-->" /></td>
								</tr>
								<tr>
									<td style="text-align:right;">Password:</td>
									<td><input type="password" name="password" id="password" style="width: 1.8in;" />
									</td>
								</tr>
								<tr>
									<td colspan="2"><input name="Login" type="submit" class="submit" id="Login"
