	...
	<script>
		function test() {
			...
			require(["dojo/dom",
					...
					"dojo/parser",
				 	"dojo/topic",
					'sl_components/forms/problem_form/widget',
				 	"sl_modules/Style",
					"sl_modules/WAPI" 
					], 
				 function(dom,domConstruct,parser,dojoTopic,sl_problemForm,slStyle,sl_wapi){
				
				 	var user = {$userInfo};
				 	try{
				 		var widget = new sl_problemForm(user,null);
