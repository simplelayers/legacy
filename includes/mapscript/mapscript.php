...
final class classObj
{
     ...
     */
    final public function __construct(layerObj $layer, classObj $class = null) {}
...
final class colorObj
{
    ...
    /**
     * Sets rgba values independently.
     * @param int $r red 0-255
     * @param int $g green 0-255
     * @param int $b blue 0-255
     * @param int $a (optional) alpha 0-255
     */
    final public function setRGB($r,$g,$b,$a=255) {}
}
...
final class imageObj
{
     ...
     * @return int
     */
    final public function saveImage($filename = '', mapObj $oMap = null) {}
...
final class layerObj
{
     ...
     * @return int
     */
    final public function setConnectionType($connectiontype, $plugin_library=null) {}
     ...
     * @return int
     */
    final public function setProcessing($processing) {}
    /**
     * Set layer :ref:`projection <projection>` and coordinate system.
     * Parameters are given as a single string of comma-delimited PROJ.4
     * parameters. Returns MS_SUCCESS or MS_FAILURE on error.
...
final class pointObj
{
     ...
     * @return int
     */
    final public function setXY($x, $y, $m=null) {}
